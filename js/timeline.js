  ...
  render() {
    ...
    el.innerHTML = `
      ...
      <div class="screen-scroll">
        <!-- Hero -->
        <div class="tl-hero">
          <div class="tl-dday" style="display:inline-flex; align-items:center; gap:6px;">
          ...
          <h2 class="tl-course"><span class="accent">${s.course.name}</span></h2>
        ...
        <div class="tl-section">
          <div class="tl-head">
            ...
            <div style="display:flex; gap:8px;">
              <button class="chip chip-live" style="border:1px solid var(--gold-500); background:transparent; color:var(--gold-500); cursor:pointer;" onclick="Register.edit(${this.schedIdx})">
                ✏️ 일정 수정
              </button>
              <button id="tl-alarm-btn" class="chip chip-live" style="border:1px solid var(--accent); background:transparent; color:var(--accent); cursor:pointer;" onclick="Timeline.toggleAlarm()">
                🔔 알람 켜기
              </button>
        ...
        <div class="quick-acts" style="display:flex; gap:12px; padding:0 var(--sp-5) var(--sp-5);">
          <button class="qact" onclick="App.navigate('restaurant')">
            <span class="qact-icon" style="display:inline-flex; width:20px; height:20px; color:var(--gold-400);">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2c3.866 0 7 3.134 7 7 0 5.25-7 13-7 13S5 14.25 5 9c0-3.866 3.134-7 7-7z"></path><circle cx="12" cy="9" r="2.5"></circle></svg>
            </span>
            <span>주변 맛집</span>
          </button>
          <button class="qact" onclick="Timeline.showChecklist()">
            <span class="qact-icon" style="display:inline-flex; width:20px; height:20px; color:var(--accent);">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"></polyline></svg>
            </span>
            <span>준비물 체크</span>
          </button>
          <button class="qact" onclick="U.downloadICS(State.schedules[${this.schedIdx}])">
            <span class="qact-icon" style="display:inline-flex; width:20px; height:20px; color:var(--text-300);">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
            </span>
            <span>일정 연동</span>
          </button>
          <button class="qact" onclick="U.openNativeAlarm(${this.schedIdx})">
            <span class="qact-icon" style="display:inline-flex; width:20px; height:20px; color:var(--red-400);">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="13" r="8"></circle><path d="M12 9v4l2 2"></path><path d="M5 3L2 6"></path><path d="M19 3l3 3"></path></svg>
            </span>
            <span>기상 알람</span>
          </button>
        </div>
    ...
    setTimeout(() => U.stagger(U.$('.tl-list'), '.tl-item', 120), 200);
  },
  ...
  renderTimelineItems(s, tl) {
      ...
      items += `
        <div class="tl-item stag">
          ...
          <div class="tl-card">
            ...
            <div class="tl-event" style="display:flex; align-items:center; gap:6px; font-size:var(--fs-lg); color:var(--text-100);">
              ${startIconHtml}
              ${startPt}에서 출발하기
            </div>
    ...
    if (tl.hasPostMeal && tl.postMealRestaurant) {
      ...
      <div class="tl-item meal stag" style="margin-top:var(--sp-4);">
        <div class="tl-dot"></div>
        <div class="tl-card" style="border: 1px solid var(--primary-200); background: linear-gradient(to right, #f8fafc, #ffffff);">
          <div class="tl-time">${tl.postMealStart}</div>
          <div class="tl-event" style="display:flex; align-items:center; gap:6px; color:var(--primary-600);">
    ...
    items += `
      <div class="tl-item stag" style="margin-top:var(--sp-4);">
        <div class="tl-dot"></div>
        <div class="tl-card" style="border: 1px solid var(--border-subtle); background: var(--bg-card);">
          <div class="tl-time">${tl.returnStart}</div>
          <div class="tl-event" style="display:flex; align-items:center; gap:6px; color:var(--text-100);">
